\begin{titlepage}
    ...
    \tikz[remember picture,overlay]{
        \node at (current page.north east) [xshift=-10.8cm,yshift=-10.2cm] {\includegraphics[width=2cm]{img/sign_student}};
        \node at (current page.north east) [xshift=-12.5cm,yshift=-22cm] {\includegraphics[width=2cm]{img/sign_student}};
        \node at (current page.north east) [xshift=-4.5cm,yshift=-22cm] {\includegraphics[width=2cm]{img/sign_teacher}};
    }
